...
The first plot is a display of the parts of speech throughout Chapter 1. This plot allowed me to test the cleanNLP package and understand how parts of speech were categorized. 
...
Cross-Chapter Examination
=======================================================================
Cross-Chapter Analysis {.sidebar}
-----------------------------------------------------------------------
This animation displays the parts of speech and how their quantities per chapter change over the course of the book. This type of quantified change over time helps to display what parts of speech are most important during specific points in the plot's timeline. 
...
ch_sep_plot <-
  ...
  labs(fill = NULL,
       x = "Count",
       y = "", 
       title = "Parts of Speech Presnt throughout The Giver",
       subtitle = "as displayed by animation running through chapters 1 through 23")

ggsave("version2.jpg", plot = ch_sep_plot)
```
...
#Sometimes the animation works better with the following code. If you use the following code instead, then uncomment the code in the chunk above. 

animate(final_animation, nframes = 350, fps = 25, width = 1200, height = 1000,
         renderer = gifski_renderer("cha_race.gif"))

```

![Final Version](cha_race.gif)
...
Why Verbs? {.sidebar}
-----------------------------------------------------------------------
Verbs are an indication of action and speech occurring in a novel. I wanted to examine the rises and falls of verbs throughout *The Giver* to see if I could determine a pattern that mirrors the plot. You will see there are three distinct rises in the amount of verbs found at the beginning, middle, and a few chapters before the end. This follows a common plot line where an introduction occurs in the beginning of a novel, with the climax of events in the middle, and the last hurrah before the final concluding details. 
